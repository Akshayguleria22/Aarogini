    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-zinc-50 dark:bg-zinc-950 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-2xl">
        ...
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <p className="text-zinc-600 dark:text-zinc-300 text-lg">Join us on your health journey</p>
        </div>

        {/* Sign Up Card */}
        <div className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-zinc-200 dark:border-zinc-800">
          <h2 className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 mb-6 text-center">Create Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              {/* Password Field */}
              <div>
                <label htmlFor="password" className="block text-sm font-semibold text-zinc-700 dark:text-zinc-200 mb-2">
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-semibold text-zinc-700 dark:text-zinc-200 mb-2">
              ...
              <div>
                <label htmlFor="phone" className="block text-sm font-semibold text-zinc-700 dark:text-zinc-200 mb-2">
                  Phone Number
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
              ...
              <div>
                <label htmlFor="dateOfBirth" className="block text-sm font-semibold text-zinc-700 dark:text-zinc-200 mb-2">
                  Date of Birth
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
          ...
          <div className="mt-4 text-center">
            <Link to="/" className="text-sm text-zinc-500 hover:text-zinc-700 transition-colors inline-flex items-center gap-1">
        ...
        <div className="mt-8 text-center space-y-2">
          <p className="text-sm text-zinc-600 dark:text-zinc-300 flex items-center justify-center gap-2">
